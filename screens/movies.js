...
<TouchableOpacity onPress={() => { navigation.navigate("Home") }}>
  ...
  console.log("k outside of loop: " + k)
    ...
    <Image style={{height: 200,
        width: 200,  bottom: -40, left: 105}} source={moviesList[getK].uri}/>
    <Text
        style={{
          bottom: -60,
          color: 'black',
    ...
    >Name:  {moviesList[getK].name}</Text>
    <Text
    style={{
      bottom: -90,
      color: 'black',
    ...
    >Year:  {moviesList[getK].year}</Text>
    <Text
    style={{
      bottom: -120,
      color: 'black',
    ...
    >Description:  {moviesList[getK].description}</Text>
