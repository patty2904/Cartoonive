...
//stores all series objects with its properties
...
export const seriesList = {
  1: {
    ...
    year: "2005",
    description:
      "The series is centered around the journey of 12-year-old Aang, the current Avatar and last survivor of his nation, the Air Nomads, along with his friends Katara, Sokka, and later Toph, as they strive to end the Fire Nation's war against the other nations of the world.",
    uri: ATLA,
    hasAdded: false,
    rating: null,
  },
  ...
  3: {
    ...
    year: "2010",
    description:
      "Adventure Time follows the adventures of a boy named Finn the Human, and his best friend and adoptive brother Jake the Dog, who has magical powers to change shape and size at will.",
    uri: AT,
    hasAdded: false,
    rating: null,
  },
  ...
  6: {
    ...
    year: "2002",
    description:
      "Kim Possible is about a high-school cheerleader who, with the help of her best friend Ron Stoppable and his pet naked mole rat Rufus, saves the world from various comical villains and still finds time to be a relatively normal girl with crushes, extracurricular activities, and high-school rivals.",
    uri: KP,
    hasAdded: false,
    rating: null,
  },
  7: {
    ...
    year: "2013",
    description:
      "Steven a young boy inherits a magical gemstone from his mother. He tries to figure out the secrets and spends his days in Beach City with the other Crystal Gems.",
    uri: SU,
    hasAdded: false,
    rating: null,
  },
  ...
  11: {
    ...
    year: "2001",
    description:
      "Timmy Turner, a young boy, is neglected by his parents and bullied by his babysitter. However, his life takes an adventurous turn when he is granted two fairy godparents who fulfil his wishes.",
    uri: FOP,
    hasAdded: false,
    rating: null,
  },
  ...
  14: {
    ...
    year: "2015",
    description:
      "When magical princess Star Butterfly receives a royal magic wand for her 14th birthday, she proves to her parents that she is not ready for the responsibility that comes with it. As a result, they send her to a place that doesn't have magic.",
    uri: SFE,
    hasAdded: false,
    rating: null,
  },
  15: {
    ...
    year: "2007",
    description:
      "This animated series from Canada spoofs survival programs by recounting the misadventures at Camp Wawanakwa, an island retreat where 22 teens compete in extreme challenges while vying for the $100,000 grand prize.",
    uri: TDD,
    hasAdded: false,
    rating: null,
  },
  16: {
    ...
    year: "2004",
    description:
      "Bloom is a special Earth girl with magical powers who travels to the Alfea School for Fairies to perfect her skills. She quickly befriends teenage fairies Stella, Flora, Musa, Layla, and Tecna. Together these six girls are the Winx Club.",
    uri: WINX,
    hasAdded: false,
    rating: null,
  },
  17: {
    ...
    year: "2015",
    description:
      "Marinette and Adrien, both in high school, are tasked with capturing akumas, creatures that make people evil. For this, both become superheroes but they do not know each other's identities.",
    uri: LADYBUG,
    hasAdded: false,
    rating: null,
  },
  ...
  21: {
    ...
    year: "2011",
    description:
      "Sensei Wu recruits four Ninjas, including Kai, a young sword-maker looking for his sister, and trains them for a specific task. They must find the four weapons of Spinjitzu before it's too late.",
    uri: NINJAGO,
    hasAdded: false,
    rating: null,
  },
  22: {
    ...
    year: "2015",
    description:
      "Three bears, Grizzly, Panda and Ice, go on a series of adventures and struggle to find their place amongst the humans of the San Francisco Bay Area.",
    uri: BEARS,
    hasAdded: false,
    rating: null,
  },
  ...
  27: {
    ...
    year: "1995",
    description:
      "Dexter is a Boy Genius Who has a secret lab in his room his Mom and Dad don't know about it, but his older sister Dee Dee Does and they go on wacky (yet Sci-fi) Capers.",
    uri: DEXTER,
    hasAdded: false,
    rating: null,
  },
  28: {
    ...
    year: "2018",
    description:
      "Young Craig and his two friends, Kelsey and John, live in Herkleston, Maryland. They experience a series of misadventures in and around their neighbourhood's creek.",
    uri: CRAIGCREEK,
    hasAdded: false,
    rating: null,
  },
  ...
  33: {
    ...
    year: "2014",
    description:
      "In the town of Aberdale, a spirited young boy called Clarence, along with his best friends Jeff and Sumo, tackles new situations in day-to-day life and goes on many exciting adventures.",
    uri: CLARENCE,
    hasAdded: false,
    rating: null,
  },
  ...
  35: {
    ...
    year: "2018",
    description:
      "Best friends Oscar and Hedgehog inadvertently enter a magical summer camp during the holidays and go on bizarre adventures as a result.",
    uri: SCI,
    hasAdded: false,
    rating: null,
  },
  36: {
    ...
    year: "2014",
    description:
      "Tom, a house cat, embarks on his adventure of persistently pursuing his never-ending quest of nabbing a notorious mouse, Jerry.",
    uri: TOMJERRY,
    hasAdded: false,
    rating: null,
  },
  37: {
    ...
    year: "1990",
    description:
      "Gaia, the spirit of the planet, assembles a diverse team of 'planeteers' who are able to combine their powers to summon an elemental warrior that takes on the appearance of superhero Captain Planet. He works with the planeteers to defend Earth from pollution caused by criminals and villains.",
    uri: CPP,
    hasAdded: false,
    rating: null,
  },
  38: {
    ...
    year: "2016",
    description:
      "Apple and Onion, two best friends, live in a big city full of other food-people and together, they take on new challenges and make friends along the way.",
    uri: AO,
    hasAdded: false,
    rating: null,
  },
  ...
  40: {
    ...
    year: "2005",
    description:
      "Juniper Lee continues her fight against the forces of mischief and chaos.",
    uri: JUNIPER,
    hasAdded: false,
    rating: null,
  },
  41: {
    ...
    year: "2005",
    description:
      "Adam Lyon got registered at the wrong school after a typo changing 'Lyon' to 'Lion'sends him to the all-animal Charles Darwin Middle School. Local zoo and aquarium kids are his classmates: gorillas, giraffes, snakes, birds, bats and fish.",
    uri: GPM,
    hasAdded: false,
    rating: null,
  },
  ...
  45: {
    ...
    year: "2003",
    description:
      "Duck Dodgers and his eager young cadet try to thwart the looming Martian invasion of the Earth.",
    uri: DD,
    hasAdded: false,
    rating: null,
  },
