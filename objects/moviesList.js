...
//stores all movie objects with its properties
...
export const moviesList = {
  ...
  18: {
    ...
    year: "2010",
    description:
      "Zoe, a little girl living in Paris, gets involved with a group of gangsters and it's up to her cat `Dino' to come to her rescue. Dino leads a double life, living with Zoe and her mother by day, and working with the burglar `Nico' by night.",
    uri: CIP,
    hasAdded: false,
    rating: null,
  },
  ...
  22: {
    ...
    year: "2014",
    description:
      " Emmet, an ordinary individual prophesied to be the Special, is entrusted with a huge responsibility of saving the Lego world from the cruel ways of Lord Business.",
    uri: LM,
    hasAdded: false,
    rating: null,
  },
  ...
  33: {
    ...
    year: "2015",
    description:
      "The ghouls are taking a bite out of Boo York! The De Niles are hoping to meet their dynastic destiny and carve out a new empire, while Catty Noir is trying to find her music.",
    uri: MH,
    hasAdded: false,
    rating: null,
  },
  ...
  35: {
    ...
    year: "2007",
    description:
      "Bloom is desperate to find her birth parents and will stop at nothing to find them. She takes a journey full of magic, and finds evil lurking around every corner.",
    uri: WINX,
    hasAdded: false,
    rating: null,
  },
  ...
  41: {
    ...
    year: "2009",
    description:
      "A young waitress, Tiana, embarks on a hilarious adventure after her fateful kiss with a frog prince who cannot wait to be human again.",
    uri: PF,
    hasAdded: false,
    rating: null,
  },
